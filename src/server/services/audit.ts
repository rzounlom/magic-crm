...
export type AuditAction =
  ...
  | "inquiry.started_working"
  | "inquiry.working_plan_updated"
  | "inquiry.ready_to_finalize"
  | "inquiry.converted_to_booking"
  | "booking.confirmed"
  | "resource.converted_to_booked"
  | "inquiry.internal_note_added"
  | "inquiry.customer_contacted"
  ...
  | "resource.hold_updated"
  | "resource.hold_extended"
